...
async def send_otp_email(otp: str, recipient_email: str, ip_address: str, device_info: str):
    ...
    template_path = Path("backend/templates/otp_admin_template.html")
    ...
    msg["Subject"] = "Your OTP Verification Code - FCIT Developers Club"
...
async def generate_otp(request:Request,email: EmailStr, db=Depends(get_misc_db)):
    ...
    return {"messages": "OTP generated successfully"}
